  ...
  if (isSelected) {
    return (
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        >
          <View style={{ flex: 1, backgroundColor: theme === TYPES.dark ? COLORS.navigation : '#0F111E' }}></View>
          <Svg
            width={75}
            height={61}
            viewBox="0 0 75 61"
          ...
          tabBarIcon: ({ focused }) => (
            <Svg width="20" height="14" viewBox="0 0 20 14">
              <Path
                ...
                fill={theme === TYPES.dark ? COLORS.white : focused ? COLORS.white : COLORS.white} />
            </Svg>
          ),
          tabBarButton: (props) => (
            <TabBarCustomButton
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            ...
            <Svg fill="none" viewBox="0 0 24 24" strokeWidth={1.8} width="30" height="30" stroke={theme === TYPES.dark ? COLORS.white : focused ? COLORS.white : COLORS.white}  >
              <Path
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            ...
            <Svg width="30" height="29" viewBox="0 0 30 29" fill="none" strokeWidth={1.8} stroke={theme === TYPES.dark ? COLORS.white : focused ? COLORS.white : COLORS.white} >
