...
import { StyleSheet, Text, View, Image, useColorScheme, TouchableOpacity, Linking, Platform, KeyboardAvoidingView, TouchableWithoutFeedback, Keyboard } from 'react-native'
