...
export default function App() {
  ...
  const [select, setselect] = React.useState<string>('Creator');
    ...
    <View style={styles.container}>
      ...
      <View style={{alignItems: 'center', marginTop: hr*20}}>
        ...
        <View
          ...
          {['Genre', 'Creator', 'Brand'].map((item, index) => {
            
            return (
              <TouchableOpacity
               key={item} onPress={() => setselect(item)}>
                <Text
                  style={{color: select === item ? '#E7E7E9' : '#9FA0A5', fontSize : select === item ? 18 : 14}}>
                  {item}
                </Text>
              </TouchableOpacity>
            );
            ...
            return (
              <View style={{width: ITEM_SIZE}}>
                <Animated.View
                  ...
                  <TouchableOpacity
                    style={{width: '100%'}}
                    onPress={() => navigation.navigate('Dropped' as never)}>
                  ...
                  <View
                    ...
                    <TouchableOpacity>
                      <Svg
                        ...
                        <Path
                          id="Vector"
                          d="M20.7663 8.23771C20.3753 7.84532 19.9111 7.53405 19.4002 7.32168C18.8893 7.10931 18.3417 7.00001 17.7887 7.00001C17.2357 7.00001 16.6881 7.10931 16.1772 7.32168C15.6663 7.53405 15.2021 7.84532 14.8112 8.23771L13.9998 9.05167L13.1884 8.23771C12.3987 7.44549 11.3277 7.00042 10.2109 7.00042C9.09409 7.00042 8.02303 7.44549 7.23334 8.23771C6.44365 9.02993 6 10.1044 6 11.2248C6 12.3452 6.44365 13.4197 7.23334 14.2119L8.0447 15.0258L13.9998 21L19.9549 15.0258L20.7663 14.2119C21.1574 13.8197 21.4677 13.354 21.6794 12.8415C21.891 12.3289 22 11.7796 22 11.2248C22 10.67 21.891 10.1207 21.6794 9.60812C21.4677 9.09558 21.1574 8.62991 20.7663 8.23771Z"
                          fill="#E7E7E9"
                        />
                      </Svg>
                    </TouchableOpacity>
                    <TouchableOpacity>
                      <Svg
                        ...
                        <Path
                          id="Vector_2"
                          d="M13 5.00001L9 1.00001L5 5.00001"
                          stroke="#E7E7E9"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                    ...
                    <TouchableOpacity>
                      <Svg width="17" height="4" viewBox="0 0 17 4" fill="none">
                        <Path
                          id="Vector"
                          d="M8.5 3.00001C9.01777 3.00001 9.4375 2.55229 9.4375 2.00001C9.4375 1.44772 9.01777 1.00001 8.5 1.00001C7.98223 1.00001 7.5625 1.44772 7.5625 2.00001C7.5625 2.55229 7.98223 3.00001 8.5 3.00001Z"
                          stroke="#E7E7E9"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        ...
                        <Path
                          id="Vector_2"
                          d="M15.0625 3.00001C15.5803 3.00001 16 2.55229 16 2.00001C16 1.44772 15.5803 1.00001 15.0625 1.00001C14.5447 1.00001 14.125 1.44772 14.125 2.00001C14.125 2.55229 14.5447 3.00001 15.0625 3.00001Z"
                          stroke="#E7E7E9"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        ...
                        <Path
                          id="Vector_3"
                          d="M1.9375 3.00001C2.45527 3.00001 2.875 2.55229 2.875 2.00001C2.875 1.44772 2.45527 1.00001 1.9375 1.00001C1.41973 1.00001 1 1.44772 1 2.00001C1 2.55229 1.41973 3.00001 1.9375 3.00001Z"
                          stroke="#E7E7E9"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
      ...
      <View style={{height: 260, width: '100%', paddingVertical: 20}}>
        <Text
          ...
          <Text style={{color: '#A259FF'}}>Drops: </Text> When we say it’s
          exclusive, it really is exclusive. Limited edition merchandise, unique
          creator experiences, branded events, shows, workshops, you name it -
          all curated by the creators themselves only for Licks Community.
        </Text>
        <TouchableOpacity
          style={{
            width: 195,
